                    ...
                    <div className="pt-4 space-y-2">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className='flex flex-col md:flex-row justify-between items-center'>
                                <button onClick={() => navigate(-1)} type="button" className=" w-full flex justify-center items-center md:my-0 my-2 md:w-1/3 mx-auto py-2 font-semibold border rounded dark:bg-green-400 dark:text-gray-900 dark:border-green-400">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 15.75L3 12m0 0l3.75-3.75M3 12h18" />
                                    </svg>
                                    <span> Go back</span>
                                </button>
                                <button type="button" className="flex justify-center items-center w-full md:my-0 my-2 md:w-1/3 mx-auto py-2 font-semibold border rounded dark:bg-green-400 dark:text-gray-900 dark:border-green-400">
