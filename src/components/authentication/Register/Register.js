            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-green-500 dark:text-gray-100">
                ...
                <form onSubmit={handleSignUp} className="space-y-6 ng-untouched ng-pristine ng-valid">
                    ...
                    <div className="space-y-1 text-sm">
                        ...
                        <input type="text" name="photoURL" id="text" placeholder="Paste your photo URL" className="w-full px-4 py-3 rounded-md text-black" />
                    </div>
                    <div className="space-y-1 text-sm">
                        <label htmlFor="username" className="block text-white">Your Email</label>
