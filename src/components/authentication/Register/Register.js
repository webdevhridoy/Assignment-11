    ...
    return (
        <div className='flex justify-center items-center align-middle h-screen md:m-0 m-5'>
            <div className="flex flex-col just w-full max-w-md p-12 space-y-4 text-white text-center dark:bg-green-500 dark:text-white-100">
                <h1 className="text-3xl font-semibold">Create an new account</h1>
                <form novalidate="" className="space-y-4 ng-untouched ng-pristine ng-valid">
                    <div className="space-y-1 text-sm">
                        <label for="text" className="block text-white dark:text-white-100">Your name</label>
                        <input type="text" name="name" id="text" placeholder="Write your name" className="w-full px-4 py-3 rounded-md dark:border-green-700 dark:bg-green-900 dark:text-white-100 focus:dark:border-violet-400" />
                    </div>
                    <div className="space-y-1 text-sm">
                        <label for="text" className="block text-white dark:text-white-100">Your photo</label>
                        <input type="text" name="photoURL" id="text" placeholder="Paste your photo URL" className="w-full px-4 py-3 rounded-md dark:border-green-700 dark:bg-green-900 dark:text-white-100 focus:dark:border-violet-400" />
                    </div>
                    <div className="space-y-1 text-sm">
                        <label for="email" className="block text-white dark:text-white-100">Your email</label>
                        <input type="email" name="email" id="email" placeholder="Write your email" className="w-full px-4 py-3 rounded-md dark:border-green-700 dark:bg-green-900 dark:text-white-100 focus:dark:border-violet-400" />
                    </div>
                    <div className="space-y-1 text-sm">
                    ...
                    <div className="flex justify-between">
                        ...
                        <p className="text-sm dark:text-white-100 text-white" href="/">Already have an account?
                    ...
                    <div className="flex items-center pt-4 space-x-1">
                        ...
                        <p className="px-3 text-sm dark:text-white-100 text-white">Login with social accounts</p>
                        <div className="flex-1 h-px sm:w-16 bg-white"></div>
                    </div>
